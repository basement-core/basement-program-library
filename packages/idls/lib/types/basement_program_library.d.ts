 ...
 * IDL can be found at `target/idl/basement_program_library.json`.
 */
export type BasementProgramLibrary = {
    "address": "AUXi5iGNkJHoxxBoeYfz8C9JquJJddPPnjoSvDZCksYF";
    "metadata": {
        "name": "basementProgramLibrary";
        "version": "0.1.0";
        "spec": "0.1.0";
...
//# sourceMappingURL=basement_program_library.d.ts.map